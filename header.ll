...
@.str.20 = private unnamed_addr constant [7 x i8] c"(void)\00", align 1
...
@.str.29 = private unnamed_addr constant [50 x i8] c"second argument to vector-set! must be an integer\00", align 1
@.str.30 = private unnamed_addr constant [47 x i8] c"first argument to vector-set! must be a vector\00", align 1
...
define i64* @alloc(i64 %m) #0 {
  ...
  %7 = call noalias i8* @_Znam(i64 %6) #7
...
; <label>:9                                       ; preds = %6
  %10 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([7 x i8], [7 x i8]* @.str.20, i32 0, i32 0))
  br label %113
...
; <label>:75                                      ; preds = %67
  ...
  store i64* %79, i64** %vec, align 8
  %80 = load i64*, i64** %vec, align 8
...
; <label>:104                                     ; preds = %67, %63
  ...
  %106 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([34 x i8], [34 x i8]* @.str.23, i32 0, i32 0), i64 %105)
  br label %107
...
define i64 @applyprim_vector(i64 %lst) #0 {
  ...
  store i64 %lst, i64* %1, align 8
  %2 = call noalias i8* @_Znam(i64 2048) #7
...
; <label>:7                                       ; preds = %0
  call void @fatal_err(i8* getelementptr inbounds ([50 x i8], [50 x i8]* @.str.29, i32 0, i32 0))
  br label %8
...
; <label>:12                                      ; preds = %8
  call void @fatal_err(i8* getelementptr inbounds ([47 x i8], [47 x i8]* @.str.30, i32 0, i32 0))
  br label %13
